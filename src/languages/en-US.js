...
module.exports = class extends Language {
  constructor(...args) {
    ...
    this.language = {
      ...
      COMMANDMESSAGE_MISSING_REQUIRED: () =>
        `You didn't use the valid format for this command.\nUse \`@${this.client.user.tag} help [command-name]\` to learn how to use this command.`,
      ...
      INHIBITOR_COOLDOWN: (remaining, guildCooldown) =>
        ...
        } already used this command. You can use this command again in ${remaining}.`,
      ...
      COMMAND_INFO_DESCRIPTION: 'Provides some information about the bot.',
      COMMAND_HELP_DESCRIPTION: 'Display help for a command or all commands.',
